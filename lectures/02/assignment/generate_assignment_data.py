#!/usr/bin/env python3
"""Generate full-size synthetic EHR data for Assignment 02."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Assignment 02 data")
    parser.add_argument(
        "--size",
        choices=["small", "large"],
        default="small",
...
def main() -> None:
    ...
    size_config = {
        "small": {"patients": 2000, "events": (10, 18)},
        "large": {"patients": 15000, "events": (12, 24)},
    }
