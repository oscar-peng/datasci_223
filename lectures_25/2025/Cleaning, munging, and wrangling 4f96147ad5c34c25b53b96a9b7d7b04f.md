...
[ML is good enough for Hydra.mp4](Cleaning,%20munging,%20and%20wrangling/ML_is_good_enough_for_Hydra.mp4)

# 🦴 X-ray vision

![data_quality.png](Cleaning,%20munging,%20and%20wrangling/data_quality.png)

## Pre-trained X-ray model

- https://github.com/mlmed/torchxrayvision (corresponding author at Stanford)
...
![xray1.png](Cleaning,%20munging,%20and%20wrangling/xray1.png)

![xray1_attention.png](Cleaning,%20munging,%20and%20wrangling/xray1_attention.png)

![xray2.png](Cleaning,%20munging,%20and%20wrangling/xray2.png)

![xray2_attention.png](Cleaning,%20munging,%20and%20wrangling/xray2_attention.png)

> *Frontal and lateral radiographs of the chest in a patient with bilateral pleural effusions; the model localizes the effusions on both the frontal (top) and lateral (bottom) views, with predicted probabilities p=0.936 and p=0.939 on the frontal and lateral views respectively*
> 

Let’s walk through an advanced task of object detection in an image by asking the pre-trained model to identify structures within an x-ray it hasn’t seen before. We’ll do this example using [Google Colab](colab.research.google.com). 
...
## Quick reminder about *virtual environments*
...
- Create an environment
    - **conda** - `conda create -n <NAME> <LIST OF PACKAGES TO INSTALL>`
        - Conda environments are *global*, they are created wherever conda is installed and can be used with any project regardless of location on the disk
    - **native** - `python3 -m venv <NAME> <LOCATION>`
        - Python environments are *local*, meaning they are created with a specific location and are most often tied to a project in the same location
...
![conda_install.png](Cleaning,%20munging,%20and%20wrangling/conda_install.png)
...
Jupyter uses python to run commands and refers to available environments as *kernels*. When opening a notebook, make sure it is using the correct kernel. In VS Code, you can find the kernel at the top right of the notebook:
...
![Untitled 5.png](Cleaning,%20munging,%20and%20wrangling/Untitled_5.png)

![kernel_select.png](Cleaning,%20munging,%20and%20wrangling/kernel_select.png)

Whenever you install new packages, you may get a warning:

![kernel_restart.png](Cleaning,%20munging,%20and%20wrangling/kernel_restart.png)

To restart the kernel, use the Restart button:

![kernel_restart_button.png](Cleaning,%20munging,%20and%20wrangling/kernel_restart_button.png)
...
![jupyter_run_cell.png](Cleaning,%20munging,%20and%20wrangling/jupyter_run_cell.png)

- **Run All** - button to run all cells, stopping at the first error. Useful when using
    - **NOTE: “**Run All” doesn’t clear anything you’ve done from memory, which *will* get you into trouble. **To run everything from a clean slate: Restart > Run All**
...
![inline_comment.png](Cleaning,%20munging,%20and%20wrangling/inline_comment.png)

- **Add Cells** - Use the `+` buttons to add Code and Markdown cells. Don’t forget to document what you’ve done with Markdown!

![add_cells.png](Cleaning,%20munging,%20and%20wrangling/add_cells.png)
...
![source_control.png](Cleaning,%20munging,%20and%20wrangling/source_control.png)
...
- *Python for Data Analysis*, McKinney (ch5-9)- author’s [website](https://wesmckinney.com/book/)
- *Python Data Science Handbook,* VanderPlas (ch3) - author’s [website](https://jakevdp.github.io/PythonDataScienceHandbook/)
...
![jupyter_data.png](Cleaning,%20munging,%20and%20wrangling/jupyter_data.png)

![jupyter_frame.png](Cleaning,%20munging,%20and%20wrangling/jupyter_frame.png)
...
![get_cols.png](Cleaning,%20munging,%20and%20wrangling/get_cols.png)
...
![drop_cols.png](Cleaning,%20munging,%20and%20wrangling/drop_cols.png)
...
![filter_cols.png](Cleaning,%20munging,%20and%20wrangling/filter_cols.png)
...
Searches can include special characters like quotes `'`, pipes `|`, and slashes `\` , but they must be *escaped* by preceding with a `\`. For example, looking for “quoted text” (including the quotes) would be `contains('\"quoted text\"')`.
...
![query_df.png](Cleaning,%20munging,%20and%20wrangling/query_df.png)
...
![df_transpose.png](Cleaning,%20munging,%20and%20wrangling/df_transpose.png)

# 🧼 Cleaning, munging, and wrangling

![File Feb 11 2023, 1 25 05 PM.jpeg](Cleaning,%20munging,%20and%20wrangling/File_Feb_11_2023_1_25_05_PM.jpeg)
...
Or did I get *wrangling* and *munging* switched?

### Following along at home

We will walk through the Pandas and data-cleaning content from Wes McKinney’s *Python for Data Analysis* (chapters 5-9)
...
4. **Enhance** by combining variables and merging related data (*we will skip this*)
5. **Validate**, and return to earlier steps as needed
6. **Export** and document

## Exploration

Exploratory data analysis is the best way to get to know each other. EDA helps to reveal what the data contains and, with some prodding, what is in there that *isn’t quite right…*
...
![df_describe.png](Cleaning,%20munging,%20and%20wrangling/df_describe.png)
...
![df_describe_cat.png](Cleaning,%20munging,%20and%20wrangling/df_describe_cat.png)
...
![df_corr.png](Cleaning,%20munging,%20and%20wrangling/df_corr.png)
...
![sns_pairplot.png](Cleaning,%20munging,%20and%20wrangling/sns_pairplot.png)
...
- Pandas Profiling: One-Line Magical Code for EDA ([kdnuggets](https://www.kdnuggets.com/2021/02/pandas-profiling-one-line-magical-code-eda.html))
...
![pandas_profiling.png](Cleaning,%20munging,%20and%20wrangling/pandas_profiling.png)
