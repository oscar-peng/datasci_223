...
![reading_sql.png](JOIN%20the%20DISTINCT%20with%20SQL/reading_sql.png)
...
![join_types.png](JOIN%20the%20DISTINCT%20with%20SQL/join_types.png)
...
- **`CAST`:**
The **`CAST`** function is handy for converting data types. Example:
...
- SQLite is *lightest* and comes installed out-of-the-box (but doesn’t have bells and whistles)
- SQLalchemy when you need to connect to a ***live database ⚡️***
...
[Fake_Claims_Data_ET.csv](JOIN%20the%20DISTINCT%20with%20SQL/Fake_Claims_Data_ET.csv)

[Fake_Cohort_ET.csv](JOIN%20the%20DISTINCT%20with%20SQL/Fake_Cohort_ET.csv)

[SQLDraft_Tang011624.pptx](JOIN%20the%20DISTINCT%20with%20SQL/SQLDraft_Tang011624.pptx)

[SQL Lecture Follow-up Notes](JOIN%20the%20DISTINCT%20with%20SQL/SQL%20Lecture%20Follow-up%20Notes%20d230e381066a4bae984cf0f5214bbfdf.md)

# Comparison to Pandas

![sql_to_pandas.png](JOIN%20the%20DISTINCT%20with%20SQL/sql_to_pandas.png)
...
![chinook_schema.png](JOIN%20the%20DISTINCT%20with%20SQL/chinook_schema.png)