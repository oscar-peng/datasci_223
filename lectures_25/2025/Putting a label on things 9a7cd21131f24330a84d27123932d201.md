...
[Lecture supplement](Putting%20a%20label%20on%20things/Lecture%20supplement%20b3950798823e4c199da8a739d3587681.md) 
...
<aside>
💡 **Guest today:** Vijay Selvaraj of [Akello.io](http://Akello.io) https://github.com/akello-io/akello

</aside>

# Preamble

1. Example analytical technical interview - [Analytics Technical Interview](https://www.notion.so/Analytics-Technical-Interview-9db281f9f10e49f298f6c6730b1a5cb2?pvs=21) 
2. Example interview take-home - https://github.com/christopherseaman/five_twelve
...
3. (*Optional*) Add files from branch back to `main` through a Pull Request

![git_branches.png](Putting%20a%20label%20on%20things/git_branches.png)
...
![wpvtr5pmskfc1.png.webp](Putting%20a%20label%20on%20things/wpvtr5pmskfc1.png.webp)
...
[UCSF Wynton HPC Cluster](https://wynton.ucsf.edu/hpc/index.html)
...
![xkcd_classification.png](Putting%20a%20label%20on%20things/xkcd_classification.png)
...
![evaluation.png](Putting%20a%20label%20on%20things/evaluation.png)
...
- **Receiver-Operator Curve (ROC Curve) and Area Under the Curve (AUC)**
    ...
    > *Plot the True Positive vs. False Positive rates, which provides a scale-invariant measure of performance. A random model on balanced class data will have a score of 0.5, while a perfect model will always have a score of 1*
    > 

![auroc.png](Putting%20a%20label%20on%20things/auroc.png)
...
![unsupervised.png](Putting%20a%20label%20on%20things/unsupervised.png)
...
![lin_vs_log.png](Putting%20a%20label%20on%20things/lin_vs_log.png)
...
![approx_optimization.png](Putting%20a%20label%20on%20things/approx_optimization.png)
...
1. **Bagging** - create *k* random samples from the data set
...
![bagging.png](Putting%20a%20label%20on%20things/bagging.png)
...
![xgboost.png](Putting%20a%20label%20on%20things/xgboost.png)
...
- **Popular frameworks** - TensorFlow, PyTorch, and Keras are commonly used deep learning frameworks for building and training deep learning models. Each framework maintains a list of tutorials/examples for getting started (and plenty more on the web + youtube):
    - **Keras**
        ...
        - *Deep Learning with Python* (free pdf)
    - **Pytorch**
...
![simpsons_paradox.png](Putting%20a%20label%20on%20things/simpsons_paradox.png)
...
![confused_classes.png](Putting%20a%20label%20on%20things/confused_classes.png)
...
<aside>
💡 The primary source of truth for FHIR Resources can be found here [https://www.hl7.org/fhir/resourcelist.html](https://www.hl7.org/fhir/resourcelist.html)
...
![Screenshot 2024-02-04 at 8.06.21 PM.png](Putting%20a%20label%20on%20things/Screenshot_2024-02-04_at_8.06.21_PM.png)
...
![Screenshot 2024-02-03 at 7.11.18 PM.png](Putting%20a%20label%20on%20things/Screenshot_2024-02-03_at_7.11.18_PM.png)
...
![Screenshot 2024-02-03 at 7.12.33 PM.png](Putting%20a%20label%20on%20things/Screenshot_2024-02-03_at_7.12.33_PM.png)

[Depression & anxiety with FHIR](Putting%20a%20label%20on%20things/Depression%20&%20anxiety%20with%20FHIR%20529ec6af5a82491bbd579bea029b51b9.md)
...
![dogs_00013.jpg](Putting%20a%20label%20on%20things/dogs_00013.jpg)

![cats_00016.jpg](Putting%20a%20label%20on%20things/cats_00016.jpg)

![panda_00001.jpg](Putting%20a%20label%20on%20things/panda_00001.jpg)
...
- K-means - https://github.com/sharmaroshan/MNIST-Using-K-means
...
- https://github.com/ThisIsJohnnyLau/dirty_data_project (6 datasets for cleaning)
...
- https://github.com/Nirzu97/PROJECT-Dental-Disease-Detection
...
- https://github.com/Nirzu97/PROJECT-Dental-Disease-Detection (see pptx for a good slide on this)
