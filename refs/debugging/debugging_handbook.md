...
[Samyak Jain](https://www.freecodecamp.org/news/author/samyakjainblog/)
...
1. **[Common Code Error Messages](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-common-code-error-messages)**
    
2. [SyntaxError: invalid syntax](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-1-syntaxerror-invalid-syntax)
    
3. [IndentationError: unexpected indent](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-2-indentationerror-unexpected-indent)
4. [NameError: name 'variable' is not defined](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-3-nameerror-name-variable-is-not-defined)
5. [AttributeError: 'module' object has no attribute 'attribute_name'](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-4-attributeerror-module-object-has-no-attribute-attributename)
6. [FileNotFoundError: [Errno 2] No such file or directory: 'filename'](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-5-filenotfounderror-errno-2-no-such-file-or-directory-filename)
7. [IndexError: list index out of range](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-6-indexerror-list-index-out-of-range)
8. [ImportError: No module named 'module_name'](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-7-importerror-no-module-named-modulename)
9. [TypeError](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-8-typeerror)
10. [ValueError](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-9-valueerror)
    
11. **[How to Debug Python Code](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-how-to-debug-python-code)**
    
12. [**Foundational Debugging** **Techniques**](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-foundational-debugging-techniques)
    
13. [Print Statements](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-print-statements)
    
14. [Logging](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-logging)
15. [Exception Handling](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-exception-handling)
16. [Assertions](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-assertions)
    
17. **** [**Advanced Debugging Techniques**](#heading-advanced-debugging-techniques)
    
18. [Unit Testing](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-unit-testing)
    
19. [Interactive Debugger (PDB)](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-how-to-use-the-interactive-debugger-pdb)
20. [Remote Debugging](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-remote-debugging)
    
21. **** [**Performance Debugging**](#performance-debugging--1)
    
22. [Code Linters and Analyzers](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-code-linters-and-analyzers)
    
23. [Profiling](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-profiling)
    
24. **[IDE Features for Debugging](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-ide-features-for-debugging)**
    
25. **[Some Additional Tips for Efficient Debugging](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-some-additional-tips-for-efficient-debugging)**
    
26. **[How to Search for Solutions to Bugs and Errors](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-how-to-search-for-solutions-to-bugs-and-errors)**
    
27. [Effective Search Strategies](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-1-effective-search-strategies)
    
28. [Leveraging Web Resources](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-2-leveraging-web-resources)
...
_If you're already familiar with common code error messages, feel free to skip this section and move straight to the [Debugging Techniques](https://www.freecodecamp.org/news/python-debugging-handbook/#heading-how-to-debug-python-code)._
...
![Image](https://www.freecodecamp.org/news/content/images/2024/01/Screenshot-2024-01-18-212824-1.png)_A snapshot of Interactive debugger mode in terminal_
...
|list (or l)|**list or list [first[, last]]:** Display the source code around the current line. Optionally, you can specify a range of lines to display.|
|print (or p)|**print expression:** Evaluate and print the value of the specified expression. This is useful for inspecting variables.|
|break (or b)|**[file:]line_number or break [function_name]:** Sets a breakpoint at the specified line number or function. When the program execution reaches the breakpoint, it will pause, allowing you to inspect variables and step through the code.|
|help|Displays list of commands or provide information about a specific command or topic(eg. help breakpoints)|
|where|Display a stack traceback of the function calls leading up to the current point in the code. Each line of the traceback typically includes the function name, the file name, and the line number where the function was called.|
...
![Image](https://www.freecodecamp.org/news/content/images/2024/01/image-101.png)_A snapshot of Breakpoint(red dot) in PyCharm_
...
![Image](https://www.freecodecamp.org/news/content/images/2024/01/image-119.png)_Stepping through code options_
...
![Image](https://www.freecodecamp.org/news/content/images/2024/01/hitCount--1-.gif)_A snapshot illustrating the process of setting Conditional breakpoint in Python code within PyCharm_
...
- **Include context details**:_**_ for example, operating system, version number of the software, libraries, or frameworks you are working with. Bugs and solutions can vary between different versions.
